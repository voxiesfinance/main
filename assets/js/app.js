...
let addr;
const sttaddr = "0x2de45af168d98e5a75ab496f407a444852a07241";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x2de45af168d98e5a75ab496f407a444852a07241";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'voxies.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x2de45af168d98e5a75ab496f407a444852a07241',
                    'symbol': 'VOXEL',
                    'decimals': '17',
                    'image': 'voxies.finance/images/logo.png',
                },
            },
